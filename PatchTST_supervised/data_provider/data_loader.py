...
class Dataset_Gaze_Height_Full(Dataset):
    def __init__(self, root_path, flag='train', size=None, 
                 features='M', data_path='chattahoochee_1hr.csv',
    ...
    def __read_data__(self):
        ...
        all_columns = ['DATE', 'DryBulbTemp', 'WetBulbTemp', 'Precip', 'RelHumidity', 'WindSpeed', 'Stationpressure', self.target]
        columns_to_read = ['DATE', 'WindSpeed', self.target]
